...
<body>
    ...
    <main>
        ...
        <div class='container'>
				...
				<a href='cadastrar_turma.php' class="botao_cadastrar_prof"> <div class='cadastro_prof'><h3 class="botao_cadastrar_prof">CADASTRAR NOVA TURMA</h3></div></a>
			<br>
			<br>
						...
						<div class="professor_info">
							<div class="professor_left">
								<div class="professor_texto">
									<span class="professor_nome">Nome da Turma</span>
								</div>
							</div>
					...
					<td>
						<div class="detalhes_content">
							<div class="detalhes_grid">
								...
								<div class="detalhe_item">
									<div class="detalhe_label"> Série da Turma:</div>
									<div class="detalhe_valor"> Informações</div>
								</div>
								<div class="detalhe_item">
									<div class="detalhe_label"> Trilha: </div>
									<div class="detalhe_valor"> Informações</div>
								</div>
								<div class="detalhe_item">
									<div class="detalhe_label"> Professor(a):</div>
									<div class="detalhe_valor"> Informações</div>
								</div>
								<div class="detalhe_item">
									<div class="detalhe_label"> Situação da Turma: </div>
									<div class="detalhe_valor"> Informações</div>
								</div>
                                <div class="detalhe_item">
									<div class="detalhe_label"> Campus: </div>
									<div class="detalhe_valor"> Informações</div>
								</div>

                                <div class="detalhe_item">
									<div class="detalhe_label"> ALunos: </div>
